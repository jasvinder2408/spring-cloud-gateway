...
import com.jasvinder.order.test.classes.CollaboratorForPartialMocking;
import com.jasvinder.order.test.classes.CollaboratorWithFinalMethods;
import com.jasvinder.order.test.classes.CollaboratorWithStaticMethods;
...
@PrepareForTest(fullyQualifiedNames = "com.jasvinder.order.test.classes.*")
public class PowerMockitoUnitTest {
    ...
    public void givenStaticMethods_whenUsingPowerMockito_thenCorrect() {
        ...
        when(CollaboratorWithStaticMethods.firstMethod(Mockito.anyString())).thenReturn("Hello world!");
